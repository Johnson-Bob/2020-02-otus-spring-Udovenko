...
public class DatabaseChangelogForTest {
  ...
  public void insertAuthors(DB db) {
    ...
    DBObject sidorov = new BasicDBObject().append("firstName", "Sidor").append("lastName",
      "Sidorov");
  ...
  public void insertBooks(DB db) {
    ...
    DBObject firstBook = new BasicDBObject("title", "My first book")
      .append("genre", "Science fiction").append("authors", fBookAuthors)
      .append("comments", fBookComments);
    DBObject secondBook = new BasicDBObject("title", "My second book").append("genre", "Fantasy")
